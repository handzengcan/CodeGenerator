...
(function(global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('vue')) : typeof define === 'function' && define.amd ? define(['vue'], factory) : (global.Quasar = factory(global.Vue));
}(this, (function(Vue) {
    'use strict';
    ...
    var langEn = {
        ...
        table: {
            ...
            selectedRows: function(rows) {
                return rows === 1 ? '1 selected row.' : (rows === 0 ? 'No' : rows) + ' selected rows.'
            },
    ...
    function bodyInit() {
        var cls = ["mat", Platform.is.desktop ? 'desktop' : 'mobile', Platform.has.touch ? 'touch' : 'no-touch', ("platform-" + (Platform.is.ios ? 'ios' : 'mat'))];
        ...
        computed: {
            ...
            modalCss: function modalCss() {
                if (this.position) {
                    ...
                    css.unshift(extend({}, positionCSS, additionalCSS(this.position)));
    ...
    var QModalLayout = {
        ...
        render: function render(h) {
            ...
            if (this.$slots.header || ("mat" !== 'ios' && this.$slots.navigation)) {
                ...
                }, [this.$slots.header, this.$slots.navigation]));
            }
    ...
    var QIcon = {
        ...
        computed: {
            icon: function icon() {
                return this.mat && "mat" === 'mat' ? this.mat : (this.ios && "mat" === 'ios' ? this.ios : this.name)
            },
            classes: function classes() {
                ...
                return this.color ? (cls + " text-" + (this.color)) : cls
            },
            content: function content() {
                return this.classes.startsWith('material-icons') ? this.icon.replace(/ /g, '_') : ' '
            },
    ...
    var QItem = {
        ...
        computed: {
            classes: function classes() {
                ...
                return this.to !== void 0 ? cls : [{
                    active: this.active
                }, cls]
            }
        },
        render: function render(h) {
            return this.to !== void 0 ? h('router-link', {
                props: this.$props,
                'class': this.classes
            }, [this.$slots.default]) : h(this.tag, {
                'class': this.classes
            }, [this.$slots.default])
        }
    }
        ...
        methods: {
            ...
            __getActions: function __getActions(h) {
                ...
                return this.actions.map(function(action) {
                    ...
                    return action.label ? h(this$1.grid ? 'div' : QItem, (obj = {
                        staticClass: this$1.grid ? 'q-actionsheet-grid-item cursor-pointer relative-position column inline flex-center' : null,
                    ...
                    obj[this$1.grid ? 'on' : 'nativeOn'] = {
                        click: function() {
                            return this$1.__onOk(action);
                        },
                        keydown: function() {
                            return this$1.__onOk(action);
                        }
                    },
                    obj), this$1.grid ? [action.icon ? h(QIcon, {
                        props: {
                            name: action.icon,
                            color: action.color
                        }
                        ...
                        staticClass: 'avatar'
                    }) : null, h('span', [action.label])] : [h(QItemSide, {
                        props: {
                            icon: action.icon,
                            color: action.color,
    ...
    var QAjaxBar = {
        ...
        computed: {
            classes: function classes() {
                return [this.position, this.animate ? '' : 'no-transition']
            },
            innerClasses: function innerClasses() {
                return ("bg-" + (this.color))
            },
            style: function style$$1() {
                var reverse = this.$q.i18n.rtl && ['top', 'bottom'].includes(this.position) ? !this.reverse : this.reverse;
                var o = translate({
                    p: this.progress,
                    pos: this.position,
                    active: this.active,
    ...
    function showRipple(evt, el, stopPropagation) {
        ...
        var offset$$1 = el.getBoundingClientRect()
          , pos = position(evt)
    ...
    var AlignMixin = {
        props: {
            align: {
                ...
                default: 'center',
                validator: function(v) {
                    return ['left', 'right', 'center', 'between', 'around'].includes(v);
                }
            }
        },
        computed: {
    ...
    var QBtn = {
        ...
        methods: {
            ...
            __startRepeat: function __startRepeat(e) {
                ...
                var setTimer = function() {
                    this$1.timer = setTimeout(trigger, typeof this$1.repeatTimeout === 'function' ? this$1.repeatTimeout(this$1.repeatCount) : this$1.repeatTimeout);
                };
                var trigger = function() {
                    if (this$1.isDisabled) {
                        return
        ...
        render: function render(h) {
            ...
            this.loading && this.hasPercentage ? h('div', {
            ...
            h('div', {
                ...
                'class': this.innerClasses
            }, this.loading ? [this.$slots.loading || h(QSpinner)] : [this.icon ? h('q-icon', {
                'class': {
            ...
            this.$slots.default,
            this.iconRight && this.isRectangle ? h('q-icon', {
        ...
        render: function render(h) {
            ...
            return h(QBtnGroup, {
                ...
                return h(QBtn, {
                    ...
                    on: {
                        click: function() {
                            return this$1.set(opt.value, opt);
                        }
                    },
                    props: {
    ...
    var QAlert = {
        ...
        render: function render(h) {
            ...
            return h('div', [h('div', {
            ...
            }, [h('div', this.$slots.default || this.message), this.detail ? h('div', {
                staticClass: 'q-alert-detail'
            }, [this.detail]) : null]), this.actions && this.actions.length ? h('div', {
                ...
                return h('div', {
                    ...
                    props: {
                        ...
                        align: 'left',
                        icon: action.icon,
                        label: action.closeBtn === true ? (typeof action.label === 'string' ? action.label : this$1.$q.i18n.label.close) : action.label
                    },
                    on: {
                        click: function() {
        ...
        methods: {
            ...
            __keyboardMoveCursor: function __keyboardMoveCursor(offset, e) {
                ...
                if (this.$refs.popover.showing) {
                    ...
                    do {
                        index = normalizeToInterval(index + offset, 0, this$1.keyboardMaxIndex);
                    ...
                    this.keyboardMoveTimer = setTimeout(function() {
                        this$1.keyboardMoveDirection = false;
                    }, 500);
                    this.keyboardIndex = index;
                    return
                }
        ...
        render: function render(h) {
            ...
            return h(QPopover, {
                ...
                return h(QItemWrapper, {
                    ...
                    nativeOn: {
                        mouseenter: function() {
                            !result.disable && (this$1.keyboardIndex = index);
                        },
                        click: function() {
                            !result.disable && this$1.setValue(result);
                        }
                    }
                });
            }))])
    ...
    var QBreadcrumbsEl = {
        ...
        render: function render(h) {
            ...
            }, this.label || this.icon ? [this.icon ? h(QIcon, {
                staticClass: 'q-breacrumbs-el-icon q-mr-sm',
                props: {
                    name: this.icon
                }
            }) : null, this.label] : [this.$slots.default])
        }
    }
    ...
    function processChanges(evt, ctx, isFinal) {
        var direction, pos = position(evt), distX = pos.left - ctx.event.x, distY = pos.top - ctx.event.y, absDistX = Math.abs(distX), absDistY = Math.abs(distY);
    ...
    var QCarousel = {
        ...
        methods: {
            ...
            goToSlide: function goToSlide(slide, fromSwipe) {
                ...
                return new Promise(function(resolve, reject) {
                    var direction = '', curSlide = this$1.slide, pos;
                    ...
                    this$1.animUid = start({
                        ...
                        easing: fromSwipe ? this$1.swipeEasing || decelerate : this$1.easing || standard,
                        apply: function(pos) {
                            this$1.position = pos;
                        },
                        done: function() {
            ...
            __planAutoPlay: function __planAutoPlay() {
                ...
                this.$nextTick(function() {
                    if (this$1.autoplay) {
                        ...
                        this$1.timer = setTimeout(this$1.next, isNumber(this$1.autoplay) ? this$1.autoplay : 5000);
                    }
                });
            },
            __cleanup: function __cleanup() {
            ...
            __setArrowKeys: function __setArrowKeys(/* boolean */
            state) {
            ...
            __getScopedSlots: function __getScopedSlots(h) {
                ...
                if (slots) {
                    return Object.keys(slots).filter(function(key) {
                        ...
                        return slots[key](this$1.slotScope);
                    })
                }
            },
            __getQuickNav: function __getQuickNav(h) {
                ...
                if (slot) {
                    ...
                    for (var i$1 = 0; i$1 < this.slidesNumber; i$1++)
                        loop$1(i$1);
                }
        ...
        render: function render(h) {
            ...
            }) : null, this.__getQuickNav(h), this.__getScopedSlots(h), this.$slots.control])
        },
        mounted: function mounted() {
            var this$1 = this;
    ...
    var QChatMessage = {
        render: function() {
            ...
            return _c('div', {
                ...
                class: {
                    'q-message-sent': _vm.sent,
                    'q-message-received': !_vm.sent
                }
            }, [(_vm.label) ? _c('p', {
            ...
            }, [(_vm.hasAvatarSlot()) ? _vm._t("avatar") : _vm._e(), _vm._v(" "), (_vm.avatar && !_vm.hasAvatarSlot()) ? _c('img', {
            ...
            }) : _vm._e(), _vm._v(" "), (_vm.text) ? _vm._l((_vm.text), function(msg, index) {
                return _c('div', {
                    key: index,
                ...
                }), _vm._v(" "), (_vm.stamp) ? _c('div', {
                    staticClass: "q-message-stamp",
                    domProps: {
                        "innerHTML": _vm._s(_vm.stamp)
                    }
                }) : _vm._e()])])
            }) : _vm._e(), _vm._v(" "), (_vm.hasDefaultSlot()) ? _c('div', {
                staticClass: "q-message-text",
                class: _vm.messageClass
            }, [_c('span', {
                staticClass: "q-message-text-content",
                class: _vm.textClass
            }, [_vm._t("default"), _vm._v(" "), (_vm.stamp) ? _c('div', {
                staticClass: "q-message-stamp",
                domProps: {
                    "innerHTML": _vm._s(_vm.stamp)
                }
        ...
        bind: function bind(el, binding) {
            ...
            var ctx = {
                ...
                move: function move(evt) {
                    ...
                    var direction, pos = position(evt), distX = pos.left - ctx.event.x, absX = Math.abs(distX), distY = pos.top - ctx.event.y, absY = Math.abs(distY);
    ...
    var FrameMixin = {
        ...
        computed: {
            ...
            fakeInputValue: function fakeInputValue() {
                return this.actualValue || this.actualValue === 0 ? this.actualValue : this.placeholder
            },
    ...
    var QInputFrame = {
        render: function() {
            ...
            return _c('div', {
                ...
                class: _vm.classes,
                attrs: {
                    "tabindex": _vm.focusable && !_vm.disable ? 0 : -1
                },
                on: {
                    "click": _vm.__onClick
                }
            }, [(_vm.before) ? _vm._l((_vm.before), function(item) {
                return _c('q-icon', {
                    key: ("b" + (item.icon)),
                    staticClass: "q-if-control q-if-control-before",
                    class: {
                        hidden: _vm.__additionalHidden(item, _vm.hasError, _vm.hasWarning, _vm.length)
                    },
                    attrs: {
                        "name": item.icon
                    },
            ...
            }) : _vm._e(), _vm._v(" "), _vm._t("default"), _vm._v(" "), (_vm.suffix) ? _c('span', {
                staticClass: "q-if-addon q-if-addon-right",
                class: _vm.addonClass,
                domProps: {
                    "innerHTML": _vm._s(_vm.suffix)
                }
            }) : _vm._e()], 2), _vm._v(" "), _vm._t("after"), _vm._v(" "), (_vm.after) ? _vm._l((_vm.after), function(item) {
                return _c('q-icon', {
                    key: ("a" + (item.icon)),
        ...
        render: function() {
            ...
            return _c('q-input-frame', {
                ...
                attrs: {
                    ...
                    "invertedLight": _vm.invertedLight,
                    "dark": _vm.dark,
                ...
                return _c('q-chip', {
                    ...
                    nativeOn: {
                        "blur": function($event) {
                            _vm.__onInputBlur($event);
                        },
                        "focus": function($event) {
                            _vm.__clearTimer($event);
                        }
                    }
                }, [_vm._v(" " + _vm._s(label) + " ")])
            ...
            }, 'input', _vm.$attrs, false))], 2), _vm._v(" "), (_vm.editable) ? _c('q-icon', {
                staticClass: "q-if-control",
                class: {
                    invisible: !_vm.input.length
                },
                attrs: {
                    "slot": "after",
                    "name": _vm.computedAddIcon
                },
                nativeOn: {
                    "mousedown": function($event) {
                        _vm.__clearTimer($event);
            ...
            store.uid = start({
                ...
                apply: function apply(pos) {
                    ...
                    css(el, {
                        ...
                        margin: store.margin ? store.margin.map(function(t) {
                            return (t[0] * pos / 100) + t[1];
                        }).join(' ') : ''
                    });
                },
    ...
    var QCollapsible = {
        ...
        render: function render(h) {
            ...
            }, [this.$slots.header ? h(QItem, this.__getItemProps(), [this.$slots.header, h(QItemSide, {
                props: {
                    right: true
                },
                staticClass: 'relative-position'
            }, this.__getToggleSide(h))]) : h(QItemWrapper, this.__getItemProps(true), this.__getToggleSide(h, true)),
            h(QSlideTransition, [h('div', {
                directives: [{
                    name: 'show',
                    value: this.showing
                }]
        ...
        methods: {
            ...
            __getContent: function __getContent(h) {
                ...
                return [h('div', {
                    ...
                    style: (obj = {},
                    obj[this.$q.i18n.rtl ? 'right' : 'left'] = this.percentage,
                    obj.borderRadius = this.square ? '0' : '50%',
                    obj),
                    'class': {
                        dragging: this.dragging,
                        'handle-at-minimum': !this.fillHandleAlways && this.model === this.min
                    }
                }, [this.label || this.labelAlways ? h(QChip, {
    ...
    var QColorPicker = {
        ...
        computed: {
            ...
            hasAlpha: function hasAlpha() {
                ...
                return this.isHex ? this.value.length > 7 : this.value && this.value.a !== void 0
            },
            ...
            saturationPointerStyle: function saturationPointerStyle() {
                ...
                obj[this.$q.i18n.rtl ? 'right' : 'left'] = ((this.model.s) + "%"),
                obj)
            },
            ...
            __getSliders: function __getSliders(h) {
                ...
                return h('div', {
                    ...
                    on: {
                        ...
                        dragend: function(val) {
                            return this$1.__onHueChange(val, true);
                        }
                    }
                })]), this.hasAlpha ? h('div', {
                    ...
                    on: {
                        input: function(value) {
                            return this$1.__onNumericChange({
                                target: {
                                    value: value
                                }
                            }, 'a', 100);
            ...
            __getNumericInputs: function __getNumericInputs(h) {
                ...
                return this.inputsArray.map(function(formatModel) {
                    ...
                    return h('div', {
                        ...
                        on: {
                            input: function(evt) {
                                return this$1.__onNumericChange(evt, formatModel, max);
                            },
                            blur: function(evt) {
                                return this$1.editable && this$1.__onNumericChange(evt, formatModel, max, true);
                            }
                        }
                    }), h('div', {
            ...
            __getInputs: function __getInputs(h) {
                ...
                var inputs = this.view === 'hex' ? [h('div', {
                    ...
                    on: {
                        ...
                        blur: function(evt) {
                            return this$1.editable && this$1.__onHexChange(evt, true);
                        }
                    },
                    staticClass: 'full-width text-center uppercase'
                }), h('div', {
                    staticClass: 'q-color-label text-center'
                }, [("HEX" + (this.hasAlpha ? ' / A' : ''))])])] : this.__getNumericInputs(h);
    ...
    var QColor = {
        ...
        computed: {
            actualValue: function actualValue() {
                ...
                if (this.value) {
                    return typeof this.value === 'string' ? this.value : ("rgb" + (this.value.a !== void 0 ? 'a' : '') + "(" + (this.value.r) + "," + (this.value.g) + "," + (this.value.b) + (this.value.a !== void 0 ? ("," + (this.value.a / 100)) : '') + ")")
                }

                return ''
            },
            modalBtnColor: function modalBtnColor() {
                return this.$q.theme === 'mat' ? this.color : (this.dark ? 'light' : 'dark')
            }
        },
        methods: {
            toggle: function toggle() {
            ...
            __getPicker: function __getPicker(h, modal) {
                ...
                var child = [h(QColorPicker, {
                    ...
                    on: {
                        input: function(v) {
                            return this$1.$nextTick(function() {
                                return this$1.__setModel(v);
                            });
                        }
                    }
                })];
        ...
        render: function render(h) {
            ...
            this.editable && this.clearable && this.actualValue.length ? h('q-icon', {
                slot: 'after',
                props: {
    ...
    var QContextMenu = {
        ...
        render: function render(h, ctx) {
            return h(Platform.is.mobile ? ContextMenuMobile : ContextMenuDesktop, ctx.data, ctx.children)
        }
    }

    var modelValidator = function(v) {
        var type = typeof v;
        return (v === null || v === undefined || type === 'number' || type === 'string' || isDate(v))
    };
    ...
    var DateMixin = {
        ...
        computed: {
            model: {
                get: function get() {
                    var date = isValid(this.value) ? new Date(this.value) : (this.defaultValue ? new Date(this.defaultValue) : startOfDate(new Date(), 'day'));

                    return getDateBetween(date, this.pmin, this.pmax)
                },
                set: function set(val) {
                    var this$1 = this;
            ...
            yearInterval: function yearInterval() {
                var min = this.pmin !== null ? this.pmin.getFullYear() : 1950
            ...
            monthInterval: function monthInterval() {
                var min = this.pmin !== null && this.pmin.getFullYear() === this.model.getFullYear() ? this.pmin.getMonth() : 0
                  , max = this.pmax !== null && this.pmax.getFullYear() === this.model.getFullYear() ? this.pmax.getMonth() : 11;
                return Math.max(1, max - min + 1)
            },
            monthMin: function monthMin() {
                return this.pmin !== null && this.pmin.getFullYear() === this.model.getFullYear() ? this.pmin.getMonth() : 0
            },
        ...
        methods: {
            ...
            __parseTypeValue: function __parseTypeValue(type, value) {
                ...
                if (type === 'year') {
                    var min = this.pmin ? this.pmin.getFullYear() : 1950
    ...
    var QDatetimePicker = {
        render: function() {
            ...
            return _c('div', {
            ...
            }, [_vm._v(" " + _vm._s(_vm.monthString) + " ")]), _vm._v(" "), _c('span', {
            ...
            }, [_vm._v(" " + _vm._s(_vm.year) + " ")])])]) : _vm._e(), _vm._v(" "), (_vm.typeHasTime) ? _c('div', {
                staticClass: "q-datetime-time row flex-center"
            }, [_c('div', {
                staticClass: "q-datetime-clockstring col-auto col-md-12"
            }, [_c('span', {
                staticClass: "q-datetime-link col-auto col-md-12",
                class: {
                    active: _vm.view === 'hour'
                },
                on: {
                    "click": function($event) {
            ...
            }, [_vm._v(" " + _vm._s(_vm.__pad(_vm.hour, '  ')) + " ")]), _vm._v(" "), _c('span', {
                staticStyle: {
                    "opacity": "0.6"
                }
            ...
            }, [_vm._v(" " + _vm._s(_vm.__pad(_vm.minute)) + " ")])]), _vm._v(" "), (!_vm.computedFormat24h) ? _c('div', {
                ...
                staticClass: "q-datetime-content col-xs-12 col-md-8 column"
            }, [_c('div', {
                ref: "selector",
                staticClass: "q-datetime-selector auto row flex-center"
            }, [(_vm.view === 'year') ? _c('div', {
            ...
            })) : _vm._e(), _vm._v(" "), (_vm.view === 'month') ? _c('div', {
                ...
                }, [_vm._v(" " + _vm._s(_vm.$q.i18n.date.months[index + _vm.monthMin - 1]) + " ")])
            })) : _vm._e(), _vm._v(" "), (_vm.view === 'day') ? _c('div', {
                ...
                attrs: {
                    ...
                    "repeatTimeout": _vm.__repeatTimeout,
                    "disable": _vm.beforeMinDays > 0 || _vm.disable || _vm.readonly
                },
                on: {
                    "click": function($event) {
            ...
            }, [_vm._v(" " + _vm._s(_vm.monthStamp) + " ")]), _vm._v(" "), _c('q-btn', {
                staticClass: "q-datetime-arrow",
                attrs: {
                    "round": "",
                    "dense": "",
                    ...
                    "repeatTimeout": _vm.__repeatTimeout,
                    "disable": _vm.afterMaxDays > 0 || _vm.disable || _vm.readonly
                },
                on: {
                    "click": function($event) {
                        _vm.setMonth(_vm.month + 1);
            ...
            }), _vm._v(" "), (_vm.min) ? _vm._l((_vm.beforeMinDays), function(fillerDay) {
                return _c('div', {
                    key: ("fb" + fillerDay),
                    staticClass: "row items-center content-center justify-center disabled"
                }, [_vm._v(" " + _vm._s(fillerDay) + " ")])
            }) : _vm._e(), _vm._v(" "), _vm._l((_vm.daysInterval), function(monthDay) {
                return _c('div', {
                    key: ("md" + monthDay),
                    staticClass: "row items-center content-center justify-center cursor-pointer",
                    class: [_vm.color && monthDay === _vm.day ? ("text-" + (_vm.color)) : null, {
                        'q-datetime-day-active': monthDay === _vm.day,
            ...
            }), _vm._v(" "), (_vm.max) ? _vm._l((_vm.afterMaxDays), function(fillerDay) {
                return _c('div', {
                    key: ("fa" + fillerDay),
                    staticClass: "row items-center content-center justify-center disabled"
                }, [_vm._v(" " + _vm._s(fillerDay + _vm.maxDay) + " ")])
            }) : _vm._e()], 2)]) : _vm._e(), _vm._v(" "), (_vm.view === 'hour' || _vm.view === 'minute') ? _c('div', {
                ref: "clock",
                staticClass: "column items-center content-center justify-center"
            }, [(_vm.view === 'hour') ? _c('div', {
            ...
            }, [_c('span')]), _vm._v(" "), (_vm.computedFormat24h) ? _c('div', _vm._l((24), function(n) {
                return _c('div', {
                    key: ("hi" + n),
                    staticClass: "q-datetime-clock-position fmt24",
                    class: [("q-datetime-clock-pos-" + (n - 1)), (n - 1) === _vm.hour ? 'active' : '']
                }, [_c('span', [_vm._v(_vm._s(n - 1))])])
            })) : _c('div', _vm._l((12), function(n) {
                return _c('div', {
                    key: ("hi" + n),
                    staticClass: "q-datetime-clock-position",
                    class: ['q-datetime-clock-pos-' + n, n === _vm.hour ? 'active' : '']
                }, [_c('span', [_vm._v(_vm._s(n))])])
            }))])]) : _vm._e(), _vm._v(" "), (_vm.view === 'minute') ? _c('div', {
                staticClass: "q-datetime-clock cursor-pointer",
                on: {
                    "mousedown": _vm.__dragStart,
                    "mousemove": _vm.__dragMove,
                ...
                staticClass: "q-datetime-clock-pointer",
                style: (_vm.clockPointerStyle)
            }, [_c('span')]), _vm._v(" "), _vm._l((12), function(n) {
                return _c('div', {
                    key: ("mi" + n),
                    staticClass: "q-datetime-clock-position",
                    class: ['q-datetime-clock-pos-' + (n - 1), (n - 1) * 5 === _vm.minute ? 'active' : '']
                }, [_c('span', [_vm._v(_vm._s((n - 1) * 5))])])
            })], 2)]) : _vm._e()]) : _vm._e()]), _vm._v(" "), _vm._t("default")], 2)])
        },
        staticRenderFns: [],
        ...
        computed: {
            ...
            daysInterval: function daysInterval() {
                ...
                if (this.beforeMinDays > 0 || after) {
                    ...
                    return Array.apply(null, {
                        length: this.daysInMonth - min - after + 1
            ...
            clockPointerStyle: function clockPointerStyle() {
                var divider = this.view === 'minute' ? 60 : (this.computedFormat24h ? 24 : 12)
            ...
            today: function today() {
                var today = new Date();
                return isSameDate(today, this.model, 'month') ? today.getDate() : -1
            }
        },
        methods: {
            /* date */
    ...
    var QDatetime = {
        ...
        computed: {
            actualValue: function actualValue() {
                ...
                return formatDate(this.value, format, /* for reactiveness */
                this.$q.i18n.date)
            },
            modalBtnColor: function modalBtnColor() {
                return this.$q.theme === 'mat' ? this.color : (this.dark ? 'light' : 'dark')
    ...
    var inputTypes = ['text', 'textarea', 'email', 'tel', 'file', 'number', 'password', 'url', 'time', 'date']
    ...
    var QScrollObservable = {
        ...
        methods: {
            ...
            emit: function emit() {
                var pos = Math.max(0, getScrollPosition(this.target))
                  , delta = pos - this.pos
                  , dir = delta < 0 ? 'up' : 'down';
    ...
    var QInput = {
        render: function() {
            ...
            return _c('q-input-frame', {
                ...
                attrs: {
                    ...
                    "top-addons": _vm.isTextarea
                },
                on: {
                    "click": _vm.__onClick,
                    "focus": _vm.__onFocus
                }
            }, [_vm._t("before"), _vm._v(" "), (_vm.isTextarea) ? [_c('div', {
            ...
            }, 'textarea', _vm.$attrs, false)), _vm._v(" "), _c('textarea', _vm._b({
                ref: "input",
            ...
            }, 'textarea', _vm.$attrs, false))], 1)] : _c('input', _vm._b({
                ref: "input",
            ...
            }, 'input', _vm.$attrs, false)), _vm._v(" "), (!_vm.disable && _vm.isPassword && !_vm.noPassToggle && _vm.length) ? _c('q-icon', {
                staticClass: "q-if-control",
                attrs: {
                    "slot": "after",
                ...
                slot: "after"
            }) : _vm._e(), _vm._v(" "), (_vm.editable && _vm.keyboardToggle) ? _c('q-icon', {
                staticClass: "q-if-control",
                attrs: {
                    "slot": "after",
                    "name": _vm.$q.icon.input[_vm.showNumber ? 'showNumber' : 'hideNumber']
                },
                nativeOn: {
                    "mousedown": function($event) {
                        _vm.__clearTimer($event);
                    ...
                    "click": function($event) {
                        _vm.toggleNumber($event);
                    }
                },
                slot: "after"
            }) : _vm._e(), _vm._v(" "), (_vm.editable && _vm.clearable && _vm.length) ? _c('q-icon', {
                staticClass: "q-if-control",
                attrs: {
                    "slot": "after",
                    "name": _vm.$q.icon.input[("clear" + (_vm.isInverted ? 'Inverted' : ''))]
                },
                nativeOn: {
                    "mousedown": function($event) {
                        _vm.__clearTimer($event);
                ...
                slot: "after"
            }) : _vm._e(), _vm._v(" "), (_vm.isLoading) ? _c('q-spinner', {
                staticClass: "q-if-control",
                attrs: {
                    "slot": "after",
                    "size": "24px"
                ...
                slot: "after"
            }) : _vm._e(), _vm._v(" "), _vm._t("after"), _vm._v(" "), _vm._t("default")], 2)
        },
        staticRenderFns: [],
        name: 'q-input',
        mixins: [FrameMixin, InputMixin],
        ...
        computed: {
            ...
            keyboardToggle: function keyboardToggle() {
                return this.$q.platform.is.mobile && this.isNumber && this.numericKeyboardToggle && length
            },
    ...
    var QOptionGroup = {
        ...
        render: function render(h) {
            ...
            return h('div', {
                ...
                return h('div', [h(this$1.component, {
                    props: {
                        value: this$1.value,
                        val: opt.value,
    ...
    var QDialog = {
            ...
            return h(QModal, {
                ...
                on: {
                    ...
                    show: function() {
                        ...
                        var node = this$1.prompt ? this$1.$refs.modal.$el.getElementsByTagName('INPUT') : this$1.$refs.modal.$el.getElementsByClassName('q-option');
        ...
        computed: {
            ...
            okProps: function okProps() {
                return Object(this.ok) === this.ok ? extend({
                    color: this.color,
            ...
            cancelProps: function cancelProps() {
                return Object(this.cancel) === this.cancel ? extend({
                    color: this.color,
    ...
    function getBtn(h, vm, btn, clickHandler, active) {
        ...
        if (btn.tip && vm.$q.platform.is.desktop) {
            var Key = btn.key ? h('div', [h('small', ("(CTRL + " + (String.fromCharCode(btn.key)) + ")"))]) : null;
    ...
    function getDropdown(h, vm, btn) {
        var label = btn.label, icon = btn.icon, noIcons = btn.list === 'no-icons', onlyIcons = btn.list === 'only-icons', contentClass, Items;
            ...
            buttonDef: function buttonDef() {
                ...
                return {
                    ...
                    h1: {
                        ...
                        icon: i.header,
                        tip: e.header1,
                        htmlTip: ("<h1 class=\"q-ma-none\">" + (e.header1) + "</h1>")
                    },
                    h2: {
                        cmd: 'formatBlock',
                        param: 'H2',
                        icon: i.header,
                        tip: e.header2,
                        htmlTip: ("<h2 class=\"q-ma-none\">" + (e.header2) + "</h2>")
                    },
                    h3: {
                        cmd: 'formatBlock',
                        param: 'H3',
                        icon: i.header,
                        tip: e.header3,
                        htmlTip: ("<h3 class=\"q-ma-none\">" + (e.header3) + "</h3>")
                    },
                    h4: {
                        cmd: 'formatBlock',
                        param: 'H4',
                        icon: i.header,
                        tip: e.header4,
                        htmlTip: ("<h4 class=\"q-ma-none\">" + (e.header4) + "</h4>")
                    },
                    h5: {
                        cmd: 'formatBlock',
                        param: 'H5',
                        icon: i.header,
                        tip: e.header5,
                        htmlTip: ("<h5 class=\"q-ma-none\">" + (e.header5) + "</h5>")
                    },
                    h6: {
                        cmd: 'formatBlock',
                        param: 'H6',
                        icon: i.header,
                        tip: e.header6,
                        htmlTip: ("<h6 class=\"q-ma-none\">" + (e.header6) + "</h6>")
                    },
                    p: {
                        cmd: 'formatBlock',
                        param: 'DIV',
            ...
            buttons: function buttons() {
                ...
                return this.toolbar.map(function(group) {
                    return group.map(function(token) {
                        ...
                        if (obj) {
                            return obj.type === 'no-state' || (userDef[token] && (obj.cmd === void 0 || (this$1.buttonDef[obj.cmd] && this$1.buttonDef[obj.cmd].type === 'no-state'))) ? obj : extend(true, {
                                type: 'toggle'
                            }, obj)
                        } else {
                            return {
    ...
    var QField = {
        ...
        computed: {
            ...
            hasBottom: function hasBottom() {
                return (this.hasError && this.errorLabel) || (this.hasWarning && this.warningLabel) || this.helper || this.count
            },
            hasLabel: function hasLabel() {
            ...
            counter: function counter() {
                if (this.count) {
                    ...
                    return Number.isInteger(this.count) ? (length + " / " + (this.count)) : length
                }
            },
            classes: function classes() {
                return {
        ...
        render: function render(h) {
            ...
            }, [this.label, this.$slots.label])]) : null,
            h('div', {
                staticClass: 'q-field-content',
                'class': this.inputClasses
            }, [this.$slots.default, this.hasBottom ? h('div', {
    ...
    var QInfiniteScroll = {
        ...
        methods: {
            poll: function poll() {
                ...
                var containerHeight = height(this.scrollContainer)
    ...
    var QKnob = {
        ...
        watch: {
            value: function value(value$1) {
                ...
                if (value$1 < this.min) {
                    ...
                    this.model = this.computedDecimals && typeof value$1 === 'number' ? parseFloat(value$1.toFixed(this.computedDecimals)) : value$1;
                }
            }
        },
        methods: {
            ...
            __onInput: function __onInput(ev, center, emitChange, dragStop) {
                ...
                var value = between(model - modulo + (Math.abs(modulo) >= this.step / 2 ? (modulo < 0 ? -1 : 1) * this.step : 0), this.min, this.max);
        ...
        render: function render(h) {
            ...
            return h('div', {
                ...
                on: {
                    click: function(e) {
                        return this$1.__onInput(e, undefined, true);
                    }
                },
                directives: [{
                    name: 'touch-pan',
            ...
            }, [this.$slots.default ? this.$slots.default : h('span', [this.model])])])])
        }
    }
    ...
    var QLayoutDrawer = {
        ...
        data: function data() {
            var largeScreenState = this.value !== void 0 ? this.value : true
        ...
        computed: {
            ...
            offset: function offset$$1() {
                return this.showing && !this.mobileOpened ? this.size : 0
            },
            ...
            backdropStyle: function backdropStyle() {
                return {
                    backgroundColor: ("rgba(0,0,0," + (this.percentage * 0.4) + ")")
                }
            },
        ...
        render: function render(h) {
            ...
            }, [this.$slots.default, h(QResizeObservable, {
                on: {
        ...
        methods: {
            __openByTouch: function __openByTouch(evt) {
                ...
                this.position = (this.$q.i18n.rtl ? !this.rightSide : this.rightSide) ? Math.max(width$$1 - position, 0) : Math.min(0, position - width$$1);
            ...
            __closeByTouch: function __closeByTouch(evt) {
                ...
                var width$$1 = this.size
                  ...
                  , position = (this.$q.i18n.rtl ? !dir : dir) ? between(evt.distance.x, 0, width$$1) : 0;
    ...
    var QLayoutFooter = {
        ...
        methods: {
            ...
            __updateRevealed: function __updateRevealed() {
                ...
                var scroll = this.layout.scroll
                  , scrollHeight = this.layout.scrollHeight
                  , height = this.layout.height;

                this.__updateLocal('revealed', scroll.direction === 'up' || scroll.position - scroll.inflexionPosition < 100 || scrollHeight - height - scroll.position < this.size + 300);
            }
        }
    }
    ...
    var QPageSticky = {
        ...
        computed: {
            ...
            computedStyle: function computedStyle() {
                ...
                var css$$1 = transforms.length ? cssTransform(transforms.join(' ')) : {};
        ...
        render: function render(h) {
            ...
            if (this.input) {
                contentMiddle.push(h(QInput, {
                    ...
                    on: {
                        input: function(value) {
                            return (this$1.newPage = value);
                        },
                        keydown: function(event) {
                            return (getEventKey(event) === 13 && this$1.__update());
                        },
                        blur: function() {
                            return this$1.__update();
                        }
                    }
                }));
            } else {
    ...
    var QRange = {
        ...
        methods: {
            __setActive: function __setActive(event) {
                ...
                var percentage = getPercentage(event, this.dragging, this.$q.i18n.rtl), type;
            ...
            __update: function __update(event) {
                var percentage = getPercentage(event, this.dragging, this.$q.i18n.rtl), model = getModel(percentage, this.min, this.max, this.step, this.computedDecimals), pos;
                ...
                case dragType.RANGE:
                    var percentageDelta = percentage - this.dragging.offsetPercentage
            ...
            __getHandle: function __getHandle(h, lower, upper, edge, percentage, color, label) {
                ...
                return h('div', {
                    ...
                    style: (obj = {},
                    obj[this.$q.i18n.rtl ? 'right' : 'left'] = ((percentage * 100) + "%"),
                    obj.borderRadius = this.square ? '0' : '50%',
                    obj),
            ...
            __getContent: function __getContent(h) {
                ...
                return [h('div', {
                    staticClass: 'q-slider-track active-track',
                    style: (obj = {},
                    obj[this.$q.i18n.rtl ? 'right' : 'left'] = ((this.percentageMin * 100) + "%"),
                    obj.width = this.activeTrackWidth,
                    obj),
                    'class': {
                        dragging: this.dragging,
        ...
        render: function render(h) {
            ...
            var loop = function(i) {
                child.push(h(QIcon, {
                    ...
                    ref: ("rt" + i),
                    props: {
                        name: this$1.icon || this$1.$q.icon.rating.icon
                    },
                    'class': {
                    ...
                    nativeOn: {
                        ...
                        mouseover: function() {
                            return this$1.__setHoverValue(i);
                        },
                        mouseout: function() {
                            this$1.mouseModel = 0;
                        },
    ...
    var QScrollArea = {
        ...
        render: function render(h) {
            ...
            }), this.$slots.default]), h(QScrollObservable, {
                on: {
    ...
    var QSearch = {
        ...
        computed: {
            ...
            controlBefore: function controlBefore() {
                return this.before || (this.noIcon ? null : [{
    ...
    var QSelect = {
        render: function() {
            ...
            return _c('q-input-frame', {
                ...
                return _c('q-chip', {
                    ...
                    on: {
                        "hide": function($event) {
                            _vm.__toggleMultiple(opt.value, _vm.disable || opt.disable);
                        }
                    },
                    nativeOn: {
                        "click": function($event) {
            ...
            }, [_vm._v(" " + _vm._s(_vm.fakeInputValue) + " ")]), _vm._v(" "), (!_vm.disable && !_vm.readonly && _vm.clearable && _vm.length) ? _c('q-icon', {
                staticClass: "q-if-control",
                attrs: {
                    "slot": "after",
                    "name": "cancel"
                ...
                slot: "after"
            }) : _vm._e(), _vm._v(" "), _c('q-icon', {
                staticClass: "q-if-control",
                attrs: {
                    "slot": "after",
                    "name": _vm.$q.icon.input.dropdown
                },
                slot: "after"
            }), _vm._v(" "), _c('q-popover', {
                ref: "popover",
                ...
                attrs: {
                    "placeholder": _vm.filterPlaceholder || _vm.$q.i18n.label.filter,
                    "debounce": 100,
                    "color": _vm.color,
                    "dark": _vm.dark,
                    "no-parent-field": "",
            ...
            }) : _vm._e(), _vm._v(" "), (_vm.visibleOptions.length) ? _c('q-list', {
                staticClass: "no-border scroll",
                attrs: {
                    "separator": _vm.separator,
                    "dark": _vm.dark
                }
            }, [(_vm.multiple) ? _vm._l((_vm.visibleOptions), function(opt, index) {
                return _c('q-item-wrapper', {
                    key: JSON.stringify(opt),
                    class: [opt.disable ? 'text-faded' : 'cursor-pointer', index === _vm.keyboardIndex ? 'q-select-highlight' : ''],
                    attrs: {
                        "cfg": opt,
                        "link": !opt.disable,
                        "slot-replace": ""
                    ...
                    nativeOn: {
                        ...
                        "mouseenter": function($event) {
                            (function(e) {
                                return !opt.disable && _vm.__mouseEnterHandler(e, index);
                            }
                            )($event);
                        }
                    }
                }, [(_vm.toggle) ? _c('q-toggle', {
                    attrs: {
                        "slot": "right",
                        "keep-color": "",
        ...
        computed: {
            optModel: function optModel() {
                ...
                if (this.multiple) {
                    return this.model.length > 0 ? this.options.map(function(opt) {
                        return this$1.model.includes(opt.value);
                    }) : this.options.map(function(opt) {
                        return false;
                    })
                }
            ...
            visibleOptions: function visibleOptions() {
                ...
                if (this.filter && this.terms.length) {
                    ...
                    opts = opts.filter(function(opt) {
                        return this$1.filterFn(lowerTerms, opt);
                    });
                }
                return opts
            },
            ...
            actualValue: function actualValue() {
                ...
                if (!this.multiple) {
                    var opt$1 = this.options.find(function(opt) {
                        return opt.value === this$1.model;
                    });
        ...
        methods: {
            ...
            __keyboardCalcIndex: function __keyboardCalcIndex() {
                ...
                this.$nextTick(function() {
                    var index = sel === void 0 ? -1 : Math.max(-1, this$1.visibleOptions.findIndex(function(opt) {
            ...
            __onBlur: function __onBlur(e) {
                ...
                setTimeout(function() {
                    var el = document.activeElement;
                    if (!this$1.$refs.popover.showing || (el !== document.body && !this$1.$refs.popover.$el.contains(el))) {
                        this$1.__onClose();
                        this$1.hide();
                    }
                }, 1);
    ...
    var StepTab = {
        ...
        render: function render(h) {
            var icon = this.vm.stepIcon ? h(QIcon, {
                props: {
    ...
    var QStep = {
        ...
        render: function render(h) {
            ...
            }) : null, h(QSlideTransition, [this.active ? h('div', {
    ...
    var QStepper = {
        ...
        computed: {
            classes: function classes() {
                var cls = [("q-stepper-" + (this.vertical ? 'vertical' : 'horizontal'))];
                if (this.color) {
                    cls.push(("text-" + (this.color)));
                }
        ...
        methods: {
            ...
            __go: function __go(offset) {
                var name, index = this.currentOrder;
                ...
                if (index === void 0) {
                    ...
                    do {
                        index += offset;
                    } while (index >= 0 && index < this.length - 1 && this.steps[index].disable)if (index < 0 || index > this.length - 1 || this.steps[index].disable) {
                        return
                    }
            ...
            __sortSteps: function __sortSteps() {
                ...
                this.$nextTick(function() {
                    if (!this$1.steps.some(function(step) {
                        return step.active;
                    })) {
    ...
    var TabMixin = {
        ...
        computed: {
            ...
            classes: function classes() {
                ...
                var color = this.data.inverted ? this.color || this.data.color : this.color;
    ...
    var QTabs = {
        render: function() {
            ...
            return _c('div', {
            ...
            }, [_vm._t("title"), _vm._v(" "), (_vm.$q.theme !== 'ios') ? _c('div', {
                staticClass: "relative-position self-stretch q-tabs-global-bar-container",
                class: [_vm.inverted && _vm.color ? ("text-" + (_vm.color)) : '', _vm.data.highlight ? 'highlight' : '']
            }, [_c('div', {
                ref: "posbar",
                staticClass: "q-tabs-bar q-tabs-global-bar",
                on: {
                    "transitionend": _vm.__updatePosbarTransition
                }
                ...
                on: {
                    "mousedown": function($event) {
                        _vm.__animScrollTo(0);
                    },
                    "touchstart": function($event) {
                        _vm.__animScrollTo(0);
                    },
                    "mouseup": _vm.__stopAnimScroll,
                    "mouseleave": _vm.__stopAnimScroll,
                    "touchend": _vm.__stopAnimScroll
                }
            }, [_c('q-icon', {
                attrs: {
                    "name": _vm.$q.icon.tabs.left
                }
            })], 1), _vm._v(" "), _c('div', {
                ref: "rightScroll",
        ...
        methods: {
            ...
            selectTabRouter: function selectTabRouter(params) {
                ...
                if (first) {
                    this.bufferTimer = setTimeout(function() {
                        var tab = this$1.buffer.find(function(t) {
                            return t.exact && t.selected;
                        }) || this$1.buffer.find(function(t) {
                            return t.selectable && t.selected;
                        }) || this$1.buffer.find(function(t) {
                            return t.exact;
                        }) || this$1.buffer.filter(function(t) {
                            return t.selectable;
                        }).sort(function(t1, t2) {
            ...
            __repositionBar: function __repositionBar() {
                ...
                this.timer = setTimeout(function() {
                    var width$$1 = el.getBoundingClientRect().width
                    ...
                    this$1.__setPositionBar(this$1.posbar.left < left ? left + width$$1 - this$1.posbar.left : this$1.posbar.left + this$1.posbar.width - left, this$1.posbar.left < left ? this$1.posbar.left : left);
                }, 20);
            },
            __setPositionBar: function __setPositionBar(width$$1, left) {
                ...
                var xPos = this.$q.i18n.rtl ? left + width$$1 : left;
                    ...
                    child.unshift(h('th', {
                        ...
                        on: {
                            input: function(val) {
                                ...
                                this$1.__updateSelection(this$1.computedRows.map(function(row) {
                                    return row[this$1.rowKey];
                                }), this$1.computedRows, val);
                            }
                        }
                    })]));
                }
            ...
            addTableHeaderRowMeta: function addTableHeaderRowMeta(data) {
                ...
                if (this.multipleSelection) {
                    Object.defineProperty(data, 'selected', {
                        get: function() {
                            return this$1.someRowsSelected ? 'some' : this$1.allRowsSelected;
                        },
                        set: function(val) {
                            if (this$1.someRowsSelected) {
                                val = false;
        ...
        methods: {
            getTableBody: function getTableBody(h) {
                ...
                if (body) {
                    ...
                    child = this.computedRows.map(function(row) {
                        var key = row[this$1.rowKey]
                          , selected = this$1.isRowSelected(key)
                          , child = bodyCell ? this$1.computedCols.map(function(col) {
                            ...
                            return slot ? slot(this$1.addBodyCellMetaData({
                                row: row,
                                col: col
                            })) : h('td', {
            ...
            addBodyRowMeta: function addBodyRowMeta(data) {
                ...
                if (this.hasSelectionMode) {
                    Object.defineProperty(data, 'selected', {
                        get: function() {
                            return this$1.isRowSelected(data.key);
                        },
                        set: function(adding) {
                ...
                Object.defineProperty(data, 'expand', {
                    get: function() {
                        return this$1.rowsExpanded[data.key] === true;
                    },
                    set: function(val) {
                ...
                data.cols = data.cols.map(function(col) {
                    ...
                    Object.defineProperty(c, 'value', {
                        get: function() {
                            return this$1.getCellValue(col, data.row);
                        }
                    });
                    return c
                });
            ...
            addBodyCellMetaData: function addBodyCellMetaData(data) {
                ...
                Object.defineProperty(data, 'value', {
                    get: function() {
                        return this$1.getCellValue(data.col, data.row);
                    }
                });
                return data
            },
    ...
    var Bottom = {
        ...
        methods: {
            ...
            getPaginationRow: function getPaginationRow(h) {
                ...
                return [h('div', {
                    staticClass: 'q-table-control'
                }, [h('div', [this.hasSelectionMode && this.rowsSelectedNumber > 0 ? (this.selectedRowsLabel || this.$q.i18n.table.selectedRows)(this.rowsSelectedNumber) : ''])]), h('div', {
                    staticClass: 'q-table-separator col'
                }), h('div', {
                    staticClass: 'q-table-control'
                }, [h('span', {
                    staticClass: 'q-table-bottom-item'
                }, [this.rowsPerPageLabel || this.$q.i18n.table.rowsPerPage]), h(QSelect, {
                    ...
                    staticClass: 'q-table-bottom-item'
                }, [rowsPerPage ? paginationLabel(this.firstRowIndex + 1, Math.min(this.lastRowIndex, this.computedRowsNumber), this.computedRowsNumber) : paginationLabel(1, this.computedRowsNumber, this.computedRowsNumber)]), h(QBtn, {
                    props: {
                        color: this.color,
                        round: true,
                        icon: this.navIcon[0],
        ...
        props: {
            sortMethod: {
                ...
                default: function default$1(data, sortBy, descending) {
                    var col = this.computedCols.find(function(def) {
            ...
            allRowsSelected: function allRowsSelected() {
                ...
                if (this.multipleSelection) {
                    return this.computedRows.length > 0 && this.computedRows.every(function(row) {
                        return this$1.selectedKeys[row[this$1.rowKey]] === true;
                    })
                }
            },
            ...
            __updateSelection: function __updateSelection(keys, rows, adding) {
                ...
                if (this.singleSelection) {
                    ...
                    this.$emit('update:selected', adding ? this.selected.concat(rows) : this.selected.filter(function(row) {
                        return !keys.includes(row[this$1.rowKey]);
                    }));
                }
            }
        }
        ...
        computed: {
            computedCols: function computedCols() {
                ...
                var cols = this.visibleColumns ? this.columns.filter(function(col) {
                    return col.required || this$1.visibleColumns.includes(col.name);
                }) : this.columns;
    ...
    var QTable = {
        name: 'q-table',
        mixins: [FullscreenMixin, Top, TableHeader, TableBody, Bottom, Sort, Filter, Pagination, RowSelection, ColumnSelection, Expand],
        props: {
            data: {
                type: Array,
                default: function() {
        ...
        render: function render(h) {
            ...
            }, [this.getTableHeader(h), this.getTableBody(h)])]), this.getBottom(h)])
        },
        methods: {
    ...
    var QTimelineEntry = {
        ...
        computed: {
            ...
            classes: function classes() {
                return [("q-timeline-entry-" + (this.side === 'left' ? 'left' : 'right')), this.icon ? 'q-timeline-entry-with-icon' : '']
            }
        },
        render: function render(h) {
            if (this.heading) {
            ...
            meta: function meta() {
                ...
                var travel = function(node, parent) {
                    ...
                    var m = {
                        ...
                        ticked: strictTicking ? this$1.innerTicked.includes(key) : (isLeaf ? this$1.innerTicked.includes(key) : false)
                    };
        ...
        methods: {
            ...
            getTickedNodes: function getTickedNodes() {
                ...
                return this.innerTicked.map(function(key) {
                    return this$1.getNodeByKey(key);
                })
            },
            ...
            __getSlotScope: function __getSlotScope(node, meta, key) {
                ...
                Object.defineProperty(scope, 'expanded', {
                    ...
                    set: function(val) {
                        val !== meta.expanded && this$1.setExpanded(key, val);
                    }
                });
                Object.defineProperty(scope, 'ticked', {
                    ...
                    set: function(val) {
                        val !== meta.ticked && this$1.setTicked([key], val);
                    }
                });
            ...
            __getChildren: function __getChildren(h, nodes) {
                ...
                return (this.filter ? nodes.filter(function(n) {
                    return this$1.meta[n[this$1.nodeKey]].matchesFilter;
                }) : nodes).map(function(child) {
                    return this$1.__getNode(h, child);
                })
            },
            ...
            __getNode: function __getNode(h, node) {
                ...
                var key = node[this.nodeKey]
                  , meta = this.meta[key]
                  , header = node.header ? this.$scopedSlots[("header-" + (node.header))] || this.$scopedSlots['default-header'] : this.$scopedSlots['default-header'];

                var children = meta.isParent ? this.__getChildren(h, node.children) : [];

                var isParent = children.length > 0 || (meta.lazy && meta.lazy !== 'loaded');

                var body = node.body ? this.$scopedSlots[("body-" + (node.body))] || this.$scopedSlots['default-body'] : this.$scopedSlots['default-body']
                ...
                h('span', {
                    ...
                    'class': this.contentClass
                }, [meta.hasTicking && !meta.noTick ? h(QCheckbox, {
                    staticClass: 'q-mr-xs',
                    props: {
                ...
                }) : null, header ? header(slotScope) : [this.__getNodeMedia(h, node), h('span', node.label)]])]),
                isParent ? h(QSlideTransition, [h('div', {
                    directives: [{
                        name: 'show',
                        value: meta.expanded
                    }],
    ...
    var QUploader = {
        render: function() {
            ...
            return _c('div', {
                ...
                staticClass: "col q-input-target ellipsis",
                class: _vm.alignClass
            }, [_vm._v(" " + _vm._s(_vm.label) + " ")]), _vm._v(" "), (_vm.uploading) ? _c('q-spinner', {
                ...
                slot: "after"
            }) : _vm._e(), _vm._v(" "), (_vm.uploading) ? _c('q-icon', {
                staticClass: "q-if-end self-center",
                attrs: {
                    "slot": "after",
                    "name": _vm.$q.icon.uploader[("clear" + (_vm.isInverted ? 'Inverted' : ''))]
                },
                nativeOn: {
                    "click": function($event) {
                        _vm.abort($event);
                ...
                staticClass: "q-uploader-pick-button q-if-control relative-position overflow-hidden",
                attrs: {
                    "slot": "after",
            ...
            }, true))]) : _vm._e(), _vm._v(" "), (!_vm.hideUploadButton && !_vm.uploading) ? _c('q-icon', {
                staticClass: "q-if-control",
                attrs: {
                    "slot": "after",
                ...
                slot: "after"
            }) : _vm._e(), _vm._v(" "), (_vm.hasExpandedContent) ? _c('q-icon', {
                staticClass: "q-if-control generic_transition",
                class: {
                    'rotate-180': _vm.expanded
                },
                attrs: {
                    "slot": "after",
                    "name": _vm.$q.icon.uploader.expand
                },
                nativeOn: {
                    "click": function($event) {
                ...
                slot: "after"
            }) : _vm._e()], 1), _vm._v(" "), _c('q-slide-transition', [_c('div', {
                directives: [{
                    name: "show",
                    rawName: "v-show",
                    value: (_vm.expanded),
                ...
                return _c('q-item', {
                ...
                }, [(!_vm.hideUploadProgress) ? _c('q-progress', {
                    staticClass: "q-uploader-progress-bg absolute-full",
                    attrs: {
                        "color": file.__failed ? 'negative' : _vm.progressColor,
                        "percentage": file.__progress,
                        "height": "100%"
                    }
                }) : _vm._e(), _vm._v(" "), (!_vm.hideUploadProgress) ? _c('div', {
                    staticClass: "q-uploader-progress-text absolute"
                }, [_vm._v(" " + _vm._s(file.__progress) + "% ")]) : _vm._e(), _vm._v(" "), (file.__img) ? _c('q-item-side', {
                    attrs: {
                    ...
                    staticClass: "cursor-pointer",
                    attrs: {
                        "icon": _vm.$q.icon.uploader[file.__doneUploading ? 'done' : 'clear'],
                        "color": _vm.color
                    },
                    nativeOn: {
                        "click": function($event) {
        ...
        computed: {
            ...
            label: function label() {
                ...
                return this.uploading ? (((this.progress).toFixed(2)) + "% (" + (humanStorageSize(this.uploadedSize)) + " / " + total + ")") : ((this.queueLength) + " (" + total + ")")
            },
        ...
        methods: {
            ...
            __filter: function __filter(files) {
                ...
                return Array.prototype.filter.call(files, function(file) {
                    return this$1.computedExtensions.some(function(ext) {
                        return file.type.startsWith(ext) || file.name.endsWith(ext);
                    })
                })
            },
            __add: function __add(e, files) {
                ...
                var filesReady = [];
                // List of image load promises
                files = files.filter(function(file) {
                    return !this$1.queue.some(function(f) {
            ...
            __getUploadPromise: function __getUploadPromise(file) {
                ...
                return new Promise(function(resolve, reject) {
                    ...
                    var resolver = this$1.urlFactory ? this$1.urlFactory(file) : Promise.resolve(this$1.url);
            ...
            upload: function upload() {
                ...
                var solved = function() {
                    ...
                    if (filesDone === length) {
                        ...
                        this$1.xhrs = [];
                        this$1.queue = this$1.queue.filter(function(f) {
                ...
                this.queue.map(function(file) {
                    return this$1.__getUploadPromise(file);
    ...
    var appFullscreen = {
        ...
        install: function install(ref) {
            ...
            var request = ['requestFullscreen', 'msRequestFullscreen', 'mozRequestFullScreen', 'webkitRequestFullscreen'].find(function(request) {
            ...
            var exit = ['exitFullscreen', 'msExitFullscreen', 'mozCancelFullScreen', 'webkitExitFullscreen'].find(function(exit) {
    ...
    function set(key, val, opts) {
        ...
        document.cookie = [encode(key), '=', stringifyCookieValue(val), time ? '; expires=' + time.toUTCString() : '', // use expires attribute, max-age is not supported by IE
        opts.path ? '; path=' + opts.path : '', opts.domain ? '; domain=' + opts.domain : '', opts.secure ? '; secure' : ''].join('');
    }

    function get(key) {
        var result = key ? undefined : {}, cookies = document.cookie ? document.cookie.split('; ') : [], i = 0, l = cookies.length, parts, name, cookie;
    ...
    var dialog = {
        ...
        install: function install(ref) {
            ...
            this.create = $q.dialog = isSSR ? function() {
                return new Promise();
            }
