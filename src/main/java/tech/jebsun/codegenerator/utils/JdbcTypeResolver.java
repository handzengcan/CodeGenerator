...
public class JdbcTypeResolver {
    ...
    static {
        ...
        typeToName.put(Types.NCHAR, TYPE_NCHAR);
        typeToName.put(Types.NCLOB, TYPE_NCLOB);
        typeToName.put(Types.NVARCHAR, TYPE_NVARCHAR);
        typeToName.put(Types.LONGNVARCHAR, TYPE_LONGNVARCHAR);
        ...
        nameToType.put(TYPE_NCHAR, Types.NCHAR);
        nameToType.put(TYPE_NCLOB, Types.NCLOB);
        nameToType.put(TYPE_NVARCHAR, Types.NVARCHAR);
        nameToType.put(TYPE_LONGNVARCHAR, Types.LONGNVARCHAR);
